...
"https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js">
 ...
 <script src="js/REVCSTLSC.js"></script> 
<title>Reverse CS India Scorecard</title>
...
<div id="forwardDashboard" style="overflow-x: hidden;">
			 <div  id= 'tblTop1'>
				<table style="width:100%;font-size: 15px;">
			  	<tr>
			    	<th style="font-size:25px;" colspan="2" id = "heading">Reverse CS TL Scorecard</th>
...
<div id="accordion">	
		...
		<table id = 'tbl' style="width: 100%;border:1px solid black">
						<caption class = 'capClass' >reverse CS TL Monthly Scorecard</caption>
				<thead>
						<tr>
							<th>Month&nbsp;</th>
							<th>Employee Id</th>
			...
			<div class="fixTableHead">
				<table id = 'tbl1' style="width: 100%;border:1px solid black">
						<caption class = 'capClass' >Reverse CS TL YTD Scorecard</caption>
						<thead>
						<tr>
							<!--	<th>Month&nbsp;</th> -->
